...
const b8 machine_code_binary[TEXT_BINARY_SIZE] = {
    0xB9, 0x82, 0x00, 0x00, 0x08, 0xBA, 0x0D, 0x00, 0x00, 0x00, 0xBB, 0x01, 0x00, 0x00, 0x00, 0xB8,
    0x04, 0x00, 0x00, 0x00, 0xCD, 0x80, 0xBB, 0x01, 0x00, 0x00, 0x00, 0xB8, 0x01, 0x00, 0x00, 0x00,
    0xCD, 0x80
};
#define DATA_BINARY_SIZE 14
const b8 data_binary[DATA_BINARY_SIZE] = {
...
FILE* start_elf(char *path) {
    ...
    elf_data_size = DATA_BINARY_SIZE;
